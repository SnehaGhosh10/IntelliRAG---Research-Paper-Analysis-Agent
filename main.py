...
# 🔧 CONFIGURATION
# =========================================================
API_KEY = "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"  # ✅ Your provided key
...
# =========================================================
# ⚙️ SAFE EMBEDDER LOADING (No torch.to())
# =========================================================
@st.cache_resource
def load_embedder():
    # ✅ Use low-resource mode (Torch-free if possible)
    return SentenceTransformer("all-MiniLM-L6-v2", device=None)
